...
(turns out there's no SP3 for x64) and updated using Legacy Update.
I then manually bumped the 32bit_dlls ini to subsystem 5.1, as it only contained
5.0 DLLs (windows 2000).
